...
import xBase.Base;
import xPOM.LoginPagePolicyBazaar;
import xPOM.MyProfilePolicyBazaar;
import xUtility.Utility;

//@Listeners(zTestNG.Listener.class)
public class PB_TC8585_ValidatePolicyUserNameUsingPropertyFile extends Base
{
	LoginPagePolicyBazaar login;
	MyProfilePolicyBazaar myProfile;
	String TCID = "PB_TC8585";
